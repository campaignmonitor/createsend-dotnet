...
namespace createsend_dotnet.Transactional
{
    ...
    {
        RateLimited<Statistics> Statistics(Guid? smartEmailId = null, string @group = null, DateTime? from = null, DateTime? to = null, DisplayedTimeZone timezone = DisplayedTimeZone.Client);
    }

    public interface IAgencyStatistics : IStatistics
    {
        RateLimited<Statistics> Statistics(string clientId, Guid? smartEmailId = null, string @group = null, DateTime? from = null, DateTime? to = null, DisplayedTimeZone timezone = DisplayedTimeZone.Client); 
    }
