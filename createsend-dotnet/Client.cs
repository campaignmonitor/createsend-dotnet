...
namespace createsend_dotnet
{
    public class Client
    {
        ...
        {
            string json = HttpHelper.Post("/clients.json", null, JsonConvert.SerializeObject(
        ...
        public ClientWithSettings Details()
        {
            ...
            return JsonConvert.DeserializeObject<ClientWithSettings>(json);
        }
        ...
        public IEnumerable<CampaignDetail> Campaigns()
        {
            ...
            return JsonConvert.DeserializeObject<CampaignDetail[]>(json);
        }
        ...
        public PagedCollection<SuppressedSubscriber> SuppressionList(int page, int pageSize, string orderField, string orderDirection)
        {
            ...
            return JsonConvert.DeserializeObject<PagedCollection<SuppressedSubscriber>>(json);
        }
        ...
        {
            HttpHelper.Put(string.Format("/clients/{0}/setbasics.json", ClientID), null, JsonConvert.SerializeObject(
                new ClientDetail() { CompanyName = companyName, ContactName = contactName, EmailAddress = emailAddress, Country = country, TimeZone = timezone })
            );
        }
        ...
        {
            HttpHelper.Put(string.Format("/clients/{0}/setaccess.json", ClientID), null, JsonConvert.SerializeObject(
        ...
        {
            HttpHelper.Put(string.Format("/clients/{0}/setpaygbilling.json", ClientID), null, JsonConvert.SerializeObject(
        ...
        {
            HttpHelper.Put(string.Format("/clients/{0}/setmonthlybilling.json", ClientID), null, JsonConvert.SerializeObject(
